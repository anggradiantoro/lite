...
clear
echo -e "${Info} XRAY CORE VPS AutoScript by SALVPN"
...
echo -e "\e[0;32m XRAY CORE VPS AutoScript by SALVPN\e[0m"
echo -e "\e[0;32m TELEGRAM @mizonesegeur\e[0m"
sleep 5
# INSTALL XRAY
...
cd /usr/bin
wget -O xray-menu "https://raw.githubusercontent.com/sallxd/lite/main/xray-menu.sh"
chmod +x xray-menu
cd
systemctl daemon-reload
